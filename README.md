...
## Overview
This project analyzes the top 20 performing Magic: The Gathering (MTG) Standard decks over the last year to identify metagame trends, dominant cards, and powerful card combinations. By scraping decklists and performance data from mtgdecks.net and aetherhub.com, the project provides insights into the Standard format's competitive landscape, highlighting potential problem cards or combos for players and deck builders.
...
- **mtggoldfish.com**: Offers archetype winrates (e.g., UR Soul Cauldron at 36.92%) and detailed decklists from recent tournaments.
